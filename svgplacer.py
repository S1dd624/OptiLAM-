...
def process_svg(svg_path, rotation_angle):
   ...
   # viewBox = svg_layer.get("viewBox")
    ...
    #the above comment no longer exists, unwanted boxes showing up in ezcad2
...
processed_svg_folder = "C:\Users\iitsi\Nesting_GA\Nesting_GA\Files\final_generator\J2LY"
output_svg_path = "C:\\Users\\iitsi\\Nesting_GA\\Nesting_GA\\Files\\final_generator\\j21opcorrected.svg"
